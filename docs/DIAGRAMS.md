<img src="/workspaces/psus/assets/img/logo.png" alt="XFT Logo" width="50"/>

# System Diagrams


This document contains sequence diagrams for all major user flows in the XFT application.
